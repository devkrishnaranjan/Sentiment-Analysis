...
graph=sns.barplot(data=d,x="Hashtag",y="Count")
graph.set(ylabel="Count")

for i in graph.patches:
    graph.text(i.get_x()+.03,i.get_height()+.05,str(i.get_height()),fontsize=15)
pos_grp_name=name+"_Positive"
plt.title(pos_grp_name)
save_pos_as=pos_grp_name+".png"
plt.savefig(save_pos_as)
...
plt.figure(figsize=(20,8))
graph=sns.barplot(data=e,x="Hashtag",y="Count")
graph.set(ylabel="Count")

for i in graph.patches:
    graph.text(i.get_x()+.03,i.get_height()+.05,str(i.get_height()),fontsize=15)
neg_grp_name=name+"_Negative"
plt.title(neg_grp_name)
save_neg_as=neg_grp_name+".png"
plt.savefig(save_neg_as)
